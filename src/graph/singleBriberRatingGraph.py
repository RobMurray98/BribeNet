...
class SingleBriberRatingGraph(RatingGraph):
    ...
    def specifics(self):
        self._bribers: Briber = self.__tmp_briber or NonBriber(self, 0)
    ...
    def is_influential(self, node_id, k=0.2, rating_method=None, **kwargs):
        g_ = deepcopy(self)
    ...
    def bribe(self, node_id, b, **kwargs):
    ...
    def eval_graph(self, rating_method=None, **kwargs):
