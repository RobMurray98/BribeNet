...
class TemporalResultsWizardFrame(tk.Frame):
    ...
    def __init__(self, parent, results):
        ...
        self.x_ret = tk.StringVar(self)
        self.y_ret = tk.StringVar(self)
        ...
        self.drop_xs = tk.OptionMenu(self, self.x_ret, *results.get_x_options())
        self.drop_xs.grid(row=1, column=1)

        self.drop_ys = tk.OptionMenu(self, self.y_ret, *results.get_y_options())
