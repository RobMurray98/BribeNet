...
def predict_small_world(graph):
    ...
    index_l = closest_index(lvs, l_ratio)
    index_c = closest_index(cvs, c_ratio)
...
def test_parameter_prediction():
    ...
    print(predict_small_world(generator.generate()))
